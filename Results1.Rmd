...
t_data <-
  auc_data %>%
=======
load(file = here::here("data", "op_2007_16",  "data_for_analysis.RData"))

t_data <-
  data_for_analysis %>%
>>>>>>> 13882a8c9c022a585cd51ef61fa3a63f68c9c4a9
...
=======
group_by(data_for_analysis, lw_rh) %>%
>>>>>>> 13882a8c9c022a585cd51ef61fa3a63f68c9c4a9
  summarise(
    count = n(),
...
p <-
  data_for_analysis  %>%
  mutate(Leaf_Wetness = factor(ifelse(lw_rh == "rainrh",
                                      "rain and rh",
                                      "only rain"))) %>%
>>>>>>> 13882a8c9c022a585cd51ef61fa3a63f68c9c4a9
  ggplot(aes(
...
# auc_data <- subset(auc_data, lw_rh == "rainrh")
# auc_data$lw_rh <- NULL
=======
#remove the data containg only rain as estimator
data_for_analysis <- 
...
<<<<<<< HEAD
```{r interactions, fig.align='center', warning= FALSE, message=FALSE}
GGally::ggpairs(auc_data,
=======
```{r interactions, fig.align='center', message=FALSE}
GGally::ggpairs(data_for_analysis,
>>>>>>> 13882a8c9c022a585cd51ef61fa3a63f68c9c4a9
...
=======
  data_for_analysis[order(data_for_analysis$hours), ] %>%
>>>>>>> 13882a8c9c022a585cd51ef61fa3a63f68c9c4a9
...
=======
  ggplot(data_for_analysis, aes(factor(rh_thresh), auc)) +
>>>>>>> 13882a8c9c022a585cd51ef61fa3a63f68c9c4a9
  geom_boxplot(width = 0.4) +
  geom_jitter(
    position = position_jitter(width = 0.2),
...
=======
  ggplot(data_for_analysis, aes(factor(temp_thresh), auc)) +
>>>>>>> 13882a8c9c022a585cd51ef61fa3a63f68c9c4a9
  geom_boxplot(width = 0.4) +
  geom_jitter(
    position = position_jitter(width = 0.2),
...
=======
lapply(data_for_analysis[, 1:3], function(x)
>>>>>>> 13882a8c9c022a585cd51ef61fa3a63f68c9c4a9
  sort(unique(x)))
```
...
```{r code_data}
<<<<<<< HEAD
cd_data <- coded.data(auc_data, Tt ~  (temp_thresh - 10),
=======
cd_data <- coded.data(data_for_analysis,
                      Tt ~  (temp_thresh - 10),
>>>>>>> 13882a8c9c022a585cd51ef61fa3a63f68c9c4a9
                      RHt ~ (rh_thresh - 90),
                      SDt ~ (hours - 12))
...
=======
poly_1_fit <-
  lm(auc ~ poly(RHt, SDt, Tt, degree = 1), data = cd_data)
poly_2_fit <-
  lm(auc ~ poly(RHt, SDt, Tt, degree = 2), data = cd_data)
poly_3_fit <-
  lm(auc ~ poly(RHt, SDt, Tt, degree = 3), data = cd_data)
poly_4_fit <-
  lm(auc ~ poly(RHt, SDt, Tt, degree = 4), data = cd_data)
...
=======
z_min <- min(data_for_analysis$auc) - c(min(data_for_analysis$auc) * 0.02)
z_max <- max(data_for_analysis$auc) + c(max(data_for_analysis$auc) * 0.02)
>>>>>>> 13882a8c9c022a585cd51ef61fa3a63f68c9c4a9
...
```{r countour, fig.show = "hold", warning=FALSE, message=FALSE,fig.width=10, fig.height=10, fig.path='figures/', dev=c('png', 'pdf')}
...
contour(poly_3_fit,
        ...
        image = TRUE,
        img.col = color_var,
        at = data.frame(Tt = 0, RHt = 0, SDt = -3))

# contour(poly_3_fit,
#         ~ Tt + RHt,
#         image = TRUE,
#         img.col = color_var,
#         at = data.frame(Tt = 0, RHt = 0, SDt = 0))
# 
# contour(poly_3_fit,
#         ~ Tt + RHt,
#         image = TRUE,
...
contour(poly_3_fit,
        ...
        image = TRUE,
        img.col = color_var,
        at = data.frame(Tt = 0, RHt = -3, SDt = 0))
...
#         image = TRUE,
#         img.col = color_var,
#         at = data.frame(Tt = -3, RHt = 0, SDt = 0))
# 
# contour(poly_3_fit,
#         ~ SDt + RHt,
#         image = TRUE,
