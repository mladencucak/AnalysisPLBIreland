...
With ROC curves constructed AUROC is calculated for each model variation. 
```{r}
...
AUC_data[AUC_data$lw_rh== "90","lw_rh"] <-"rain_rh"
AUC_data[,1:3] <- lapply(AUC_data[,1:3], as.numeric); rm(parameters)
