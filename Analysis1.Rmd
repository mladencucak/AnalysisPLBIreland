...
Extract the model formula. the code has been borrowd from [this StackOverflow thread](https://stackoverflow.com/questions/50116648/how-do-i-convert-the-following-poly-output-to-a-function-useable-in-excel)
...
prettyModel;rm(processPolyNames,coefs,prettyNames,prettyModel)
```

Visualise fitted response surface. Note that AUROC Z values are multiplied by 10,
scaled 0 - 1.0, for graphing purposes only.
