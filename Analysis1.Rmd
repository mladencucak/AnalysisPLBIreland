...
```{r further_analysis, fig.show = "hold", warning=FALSE, fig.width=11, fig.height=11,message=FALSE, fig.path='figures/', dev=c('png', 'pdf')}
...
cowplot::plot_grid(pl[[1]], pl[[2]], pl[[3]],pl[[4]], nrow=2)
```
