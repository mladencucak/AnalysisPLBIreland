...
```{r further_analysis, fig.show = "hold", warning=FALSE, message=FALSE,fig.width=5, fig.height=5, fig.path='figures/', dev=c('png', 'pdf')}
# 
# par(
#     mfrow = c(1, 4)
#   )
...
mod_list <-  list(ROC_data[["90_10_12_rain"]],
                  ...
                  ROC_data[["87_13_12_rainrh"]],
                  ROC_data[["88_12_9_rainrh"]])
