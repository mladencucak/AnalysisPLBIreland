...
if ("gt" %in% !isTRUE(installed.packages()))
...
if (any(as.numeric(packages_load) == 0)) {
  warning("Package/s", paste(list.of.packages[!isTRUE(packages_load)]),
          "not loaded!")
} else {
...
```{r}
data
save(data, file = here::here("data", "op_2007_16",  "data_for_analysis.RData"))
```
