...
Packages needed for the analysis are loaded. If the libraries do not exist locally, they will be downloaded and installed automatically.
...
AUROC_data <- data.frame(AUROC_data)
head(AUROC_data) %>%
  gt()
```
...
```{r}
data
save(data, file = here::here("data", "op_2007_16",  "AUROC_data.RData"))
```
