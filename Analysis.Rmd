...
According to original Irish Rules (Bourke, 1953), temperatures ≥ 10℃ and relative humidity ≥ 90 % provide the necessary environmental conditions considered conducive for potato late blight. Potato late blightThe blight epidemic onset risk is then estimated during periods fulfilling the following criteria:   
...
```{r}
data
save(data, file = here::here("data", "op_2007_16",  "data.RData"))
